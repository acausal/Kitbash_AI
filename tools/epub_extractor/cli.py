"""cli for tools.epub_extractor. Usage:
    python -m tools.epub_extractor input.epub [-o out.md]
Exit 0 on success, 1 on failure (stderr message)."""
from __future__ import annotations
import argparse, os, sys
from . import convert_epub_to_markdown

def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="epub_extractor",
        description="EPUB -> clean text (ebooklib).")
    ...
    try:
        convert_epub_to_markdown(a.input, out)
