"""cli for tools.html_extractor. Usage:
    python -m tools.html_extractor input.html [-o out.md]
Exit 0 on success, 1 on failure (stderr message)."""
from __future__ import annotations
import argparse, os, sys
from . import convert_html_to_markdown

def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="html_extractor",
        description="HTML -> clean text (stdlib HTMLParser).")
    ...
    try:
        convert_html_to_markdown(a.input, out)
