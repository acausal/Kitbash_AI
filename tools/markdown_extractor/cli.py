"""cli for tools.markdown_extractor. Usage:
    python -m tools.markdown_extractor input.md [-o out.md]
Exit 0 on success, 1 on failure (stderr message)."""
from __future__ import annotations
import argparse, os, sys
from . import convert_markdown_to_markdown

def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="markdown_extractor",
        description="Markdown -> normalized pass-through text (stdlib).")
    ...
    try:
        convert_markdown_to_markdown(a.input, out)
