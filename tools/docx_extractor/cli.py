"""cli for tools.docx_extractor. Usage:
    python -m tools.docx_extractor input.docx [-o out.md]
Exit 0 on success, 1 on failure (stderr message)."""
from __future__ import annotations
import argparse, os, sys
from . import convert_docx_to_markdown

def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="docx_extractor",
        description="DOCX -> clean text (python-docx).")
    ...
    try:
        convert_docx_to_markdown(a.input, out)
