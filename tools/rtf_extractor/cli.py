"""cli for tools.rtf_extractor. Usage:
    python -m tools.rtf_extractor input.rtf [-o out.md]
Exit 0 on success, 1 on failure (stderr message)."""
from __future__ import annotations
import argparse, os, sys
from . import convert_rtf_to_markdown

def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="rtf_extractor",
        description="RTF -> clean text (striprtf).")
    ...
    try:
        convert_rtf_to_markdown(a.input, out)
