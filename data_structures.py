...
class PhantomCandidate:
    ...
    polarity: float = 0.0              # -1.0 (weak/shadow) to +1.0 (strong/warmth)
                                       # Based on confidence consistency + hit patterns
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "polarity": round(self.polarity, 3),  # NEW: Resonance Web signal
            "status": self.status,
